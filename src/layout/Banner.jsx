  ...
  return (
    <section id={id} className='group relative  md:pt-[100px] pt-[130px]'>
      <Container>
        ...
        <Image className='w-full ' src={Bannertwo} />
...
z-10 duration-500 flex flex-col items-center justify-center py-[10px] md:py-[50px] '>
          ...
          <h1 className='text-[40px] text-white font-dm font-normal'>Full Stack Developer</h1>
  ...
  Passionate about building modern, scalable, and user-friendly web applications. I specialize in both front-end and back-end development using React, Node.js, Express, and MongoDB.
          </p>
